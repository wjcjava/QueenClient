...
public class FansCommentListAdapter extends RecyclerView.Adapter<FansCommentListAdapter.ViewHolder> {
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public FansCommentListAdapter(Context context, List<DemoListModel.BodyEntity.MessListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }

    public FansCommentListAdapter(Context context) {
        mContext = context;
        if (mDatas == null) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_comment_content, parent, false);
