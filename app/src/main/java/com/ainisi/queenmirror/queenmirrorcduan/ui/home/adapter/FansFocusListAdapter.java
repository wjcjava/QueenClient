...
public class FansFocusListAdapter extends RecyclerView.Adapter<FansFocusListAdapter.ViewHolder> {
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public FansFocusListAdapter(Context context, List<DemoListModel.BodyEntity.MessListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_focus_content, parent, false);
