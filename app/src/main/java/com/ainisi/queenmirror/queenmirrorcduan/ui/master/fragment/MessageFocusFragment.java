...
import com.ainisi.queenmirror.queenmirrorcduan.ui.home.adapter.FansFocusListAdapter;
 ...
 */
public class MessageFocusFragment extends BaseFragment {
    ...
    public MessageFocusFragment() {
        // Required empty public constructor
    }

    public static MessageFocusFragment newInstance(String content) {
        Bundle arguments = new Bundle();
        arguments.putString(EXTRA_CONTENT, content);
        MessageFocusFragment tabContentFragment = new MessageFocusFragment();
    ...
    protected void doFitsrData() {
        ...
        FansFocusListAdapter itemReclAdapter = new FansFocusListAdapter(getActivity(),messListEntityList);
