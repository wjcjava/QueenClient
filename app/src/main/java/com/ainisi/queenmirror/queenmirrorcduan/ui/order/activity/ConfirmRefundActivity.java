...
public class ConfirmRefundActivity extends BaseNewActivity implements HttpCallBack {
    ...
    protected void initView() {
        super.initView();
        loadingDialog = new LoadingDialog(ConfirmRefundActivity.this);
        ...
        for (int i = 0; i < areFundCheckList.size(); i++) {
            ...
            L.e("...............         " + Double.parseDouble(areFundCheckList.get(i).getIntfAnsOrderDetails().getAfterAmount()));
        }
        if (amount < 0) {
            amount = 0;
        }
        tv_confirm_amount.setText("¥" + MD5.doubleToString(amount + ""));

        ConfirmRefundAdapter confirmRefundAdapter = new ConfirmRefundAdapter(ConfirmRefundActivity.this, R.layout.confirmrefund_re_listitem, areFundCheckList);
    ...
    private void DoOutData() {
        ...
        params.put("custId", SP.get(ConfirmRefundActivity.this, SpContent.UserId, "0") + "");
        ...
        params.put("token", SP.get(ConfirmRefundActivity.this, SpContent.UserToken, "") + "");
        ...
        DWImages.parserResult(requestCode, data, new DWImages.GetImagesCallback() {
            ...
            public void onResult(final List<String> images) {
                ...
                for (int i = 0; i < images.size(); i++) {
                    ...
                    Luban.with(ConfirmRefundActivity.this) // 初始化
                            .load(oldFile) // 要压缩的图片
