...
public class MessageThumbsUpListAdapter extends RecyclerView.Adapter<MessageThumbsUpListAdapter.ViewHolder> {
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public MessageThumbsUpListAdapter(Context context, List<DemoListModel.BodyEntity.MessListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }

    public MessageThumbsUpListAdapter(Context context) {
        mContext = context;
        if (mDatas == null) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_thumbs_up_content, parent, false);
