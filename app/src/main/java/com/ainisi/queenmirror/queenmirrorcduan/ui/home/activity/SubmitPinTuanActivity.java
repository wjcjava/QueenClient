 ...
 * 我的订单
 */
public class SubmitPinTuanActivity extends BaseNewActivity implements HttpCallBack{
    ...
    String amount = "0",aliPayResult="",type="0",groupId;
    ...
    private IWXAPI api;
    public static SubmitPinTuanActivity instance = null;
    ...
    public void initView() {
        ...
        re_queen.setVisibility(View.GONE);
    ...
    private void initEvent() {
        dt_submit_downtime.setDownTimerListener(new OnCountDownTimerListener() {
            ...
            public void onFinish() {
                Toast.makeText(SubmitPinTuanActivity.this, "当前订单已失效，请重新下单", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
    ...
    private void showDialogs(int grary, int animationStyle) {
        final BaseDialog.Builder builder = new BaseDialog.Builder(SubmitPinTuanActivity.this);
    ...
    private void PayInYueData() {
        ...
        params.put("custId", SP.get(SubmitPinTuanActivity.this,SpContent.UserId,"0")+"");
        params.put("token", SP.get(SubmitPinTuanActivity.this,SpContent.UserToken,"")+"");
        ...
        HttpUtils.doPost(ACTION.ORDERyuepay, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    private void PayInNvwangData() {
        ...
        params.put("businessIds",businessIds);
        params.put("payPass", MD5.md5(input_pass+ "MYN888"));
        HttpUtils.doPost(ACTION.ORDERNVWANGPAy, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    private void showDialog(int grary, int animationStyle) {
        ...
        final BaseDialog dialog = builder.setViewId(R.layout.paypass_dialog)
                ...
                .addViewOnClickListener(R.id.tv_setting_pay, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(SubmitPinTuanActivity.this,ModifyPayActivity.class);
    ...
    private void startPay() {
        Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(SubmitPinTuanActivity.this);
    ...
    private void getData() {
        ...
        params.put("businessIds", businessIds);
        HttpUtils.doPost(ACTION.ORDERZHIFUBAOPAY, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    private void PayByWechatData() {
        HashMap<String, String> params = new HashMap<>();
        params.put("custId", SP.get(SubmitPinTuanActivity.this,SpContent.UserId,"")+"");
        params.put("token", SP.get(SubmitPinTuanActivity.this,SpContent.UserToken,"")+"");
        params.put("platformType","3");
        if (amount.substring(0, 1).equals("¥")) {
            params.put("payAmount", amount.substring(1, amount.length()));
        ...
        params.put("businessIds",businessIds);
        params.put("spbillCreateIp",getIP(SubmitPinTuanActivity.this));
        params.put("openId","");
        HttpUtils.doPost(ACTION.GPORDERWECHATPAY, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    ...
    private void sendPayRequest() {
        ...
        SP.put(SubmitPinTuanActivity.this,SpContent.PayWhere,"4");//代表拼团
            ...
            case ACTION.ORDERyuepay:
                ...
                if(queenPayBeans.getErrorCode().equals("6")){
                    ...
                    if (queenPayBeans.isSuccess()) {
                        ...
                        intent.putExtra("groupId", groupIds);
                        intent.putExtra("orderNo", businessIds);
