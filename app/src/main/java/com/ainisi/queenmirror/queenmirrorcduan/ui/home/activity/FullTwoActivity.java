...
import com.ainisi.queenmirror.queenmirrorcduan.ui.home.bean.SecKillDetailBean;
...
public class FullTwoActivity extends BaseNewActivity implements HttpCallBack {
    ...
    protected void initData() {
        ...
        isLogin = SP.get(FullTwoActivity.this, SpContent.isLogin, "0").toString();
        userId = SP.get(FullTwoActivity.this, SpContent.UserId, "0").toString();
        mShareListener = new CustomShareListener(FullTwoActivity.this);

        inithttp();
        getProductDetailData();

        getShopScore();
        if (SP.get(FullTwoActivity.this, SpContent.isLogin, "0").equals("1")) {
            shareData();
        }
        ...
        li_youhui.setVisibility(View.VISIBLE);
        view_top.setVisibility(View.GONE);
        mLiFullactivityDiscount.setVisibility(View.GONE);
        mLiFullactivityModou.setVisibility(View.GONE);
    }
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private WeakReference<FullTwoActivity> mActivity;

        private CustomShareListener(FullTwoActivity activity) {
    ...
    private void getProductDetailData() {
        ...
        params.put("token", SP.get(FullTwoActivity.this, SpContent.UserToken, "") + "");
        HttpUtils.doPost(ACTION.SECKILLGOODSDETAILS, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    private void doAddDetailData() {
        ...
        HttpUtils.doPost(ACTION.GOODSBROWSESCHANGE, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    private void initshophttp() {
        ...
        hashMap1.put("cityCode", SP.get(this, SpContent.CityCode, "0512") + "");
        hashMap1.put("pageSize", SpContent.pageSize);
        hashMap1.put("token", SP.get(FullTwoActivity.this, SpContent.UserToken, "") + "");
    ...
    private void inithttp() {
        ...
        hashMap.put("token", SP.get(FullTwoActivity.this, SpContent.UserToken, "") + "");
    ...
    private void getShopScore() {
        ...
        params.put("token", SP.get(FullTwoActivity.this, SpContent.UserToken, "") + "");
        HttpUtils.doPost(ACTION.GOODSSCOREGET, params, CacheMode.REQUEST_FAILED_READ_CACHE, true, this);
    }
    ...
    @OnClick({R.id.tv_purchase, R.id.title_back, R.id.tv_full_shoppingcart, R.id.rl_full_collection, R.id.title_photo, R.id.re_full_shop
            ...
            , R.id.tv_fullactivity_detail_bottom, R.id.li_fullactivity_comment_bottom, R.id.tv_full_navigation, R.id.tv_fullactivity_tishi_bottom})
    public void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.li_fullactivity_comment_bottom:
                ...
                tv_fullactivity_detail_bottom.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                li_fullactivity_comment_bottom.setBackground(FullTwoActivity.this.getDrawable(R.drawable.shape_seckill_white));
                tv_fullactivity_detail.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                tv_fullactivity_tishi_bottom.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                li_fullactivity_comment.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.white));
                break;
            /**
             * 点击商品详情
             */
            ...
            case R.id.tv_fullactivity_detail_bottom:
                ...
                ic_fullactivity_tishi.setVisibility(View.GONE);
                tv_fullactivity_detail_bottom.setBackground(FullTwoActivity.this.getDrawable(R.drawable.shape_seckill_white));
                li_fullactivity_comment_bottom.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                tv_fullactivity_detail.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.white));
                li_fullactivity_comment.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                tv_fullactivity_tishi_bottom.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
            ...
            case R.id.tv_fullactivity_tishi_bottom:
                ...
                tv_fullactivity_detail.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.white));
                li_fullactivity_comment.setBackgroundColor(FullTwoActivity.this.getResources().getColor(R.color.color_F4F4F4));
                tv_fullactivity_tishi_bottom.setBackground(FullTwoActivity.this.getDrawable(R.drawable.shape_seckill_white));
                break;
            /**
             * 客服电话
             */
...
//                if (isLogin.equals("1")) {
//                    Intent intent = new Intent(FullTwoActivity.this, PurchaseNowActivity.class);
...
//                }
            ...
            case R.id.tv_full_navigation:
                if (NavtagationUtil.isAvilible(FullTwoActivity.this, "com.baidu.BaiduMap")) {
                    isbaidu = true;
                }
                if (NavtagationUtil.isAvilible(FullTwoActivity.this, "com.autonavi.minimap")) {
                    isgaode = true;
                }
                if (NavtagationUtil.isAvilible(FullTwoActivity.this, "com.tencent.map")) {
                    istencent = true;
                }
...
//                        full_activity_number_score.setText(prices);
            ...
            case ACTION.INVITEPRIZE:
                ...
                if (invitePaizeBean.getErrorCode().equals("6")) {
                    ...
                    if (invitePaizeBean.isSuccess()) {
                        ...
                        mShareAction = new ShareAction(FullTwoActivity.this).setDisplayList(
                            ...
                            public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                                ...
                                web.setThumb(new UMImage(FullTwoActivity.this, urlIcon));
                                new ShareAction(FullTwoActivity.this).withMedia(web)
             ...
             * 商品详情
             */
            case ACTION.SECKILLGOODSDETAILS:
                loadingDialog.cancel();
                SecKillDetailBean productDetailBean = GsonUtil.toObj(res, SecKillDetailBean.class);
                if (productDetailBean.isSuccess()) {
//                    String isCollection = productDetailBean.getBody().getGoodsListData();
...
//                    }
                    ...
                    goods_pic = productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsDetails();
                    ...
                    FullDetailListViewAdapter fullListViewAdapter = new FullDetailListViewAdapter(FullTwoActivity.this, good_pic_detail);
                    nsli_fullactivity_detail_pic.setAdapter(fullListViewAdapter);

//                    buyRules = productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getBuyRule();
...
//                        isBean = "";
//                    } else {
//                        tv_full_buy_bean.setText("另需支付魔豆：" + MD5.doubleToString(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getPointRule()));
...
//                    goods_content = productDetailBean.getBody().getGoodsListData().getEcGoodsBasic().getGoodsBrief();
                    ...
                    goods_image = productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsPic();
                    ...
                    NumberFormat nf = NumberFormat.getInstance();
                    price = MD5.doubleToString(String.valueOf(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getOnlinePrice())) + "";
                    String price1 = nf.format(Double.parseDouble(String.valueOf(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getOfflinePrice()))) + "";
...
//                    }
                    ...
                    tv_shopping_oldprice.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG); //中划线
                    tv_brief.setText(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getServiceDesc());
                    if (TextUtils.isEmpty(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getServiceDuration())) {
                        tv_time.setText("服务时长：等待店铺填充");
                    } else {
                        tv_time.setText("服务时长：" + productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getServiceDuration() + "分钟");
                    }
                    if (TextUtils.isEmpty(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsPageView())) {
                        textView4.setText("已浏览：1次");
                    } else {
                        textView4.setText("已浏览：" + productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsPageView() + "次");
                    }
                    //  tv_introduction.setText(productDetailBean.getBody().getGoodsListData().getEcGoodsBasic().getGoodsDetails().toString());
                    fullTitle.setText(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsName());
                    tv_fullactivity_name.setText(productDetailBean.getBody().getGoodsListData().getAnsSecKillGoods().getGoodsName());
                    SecKillDetailBean.BodyBean.GoodsListDataBean.AnsShopBasicBean ansShopBasic = productDetailBean.getBody().getGoodsListData().getAnsShopBasic();
                    ...
                    latitude = String.valueOf(ansShopBasic.getGeoY());
                    longitude = String.valueOf(ansShopBasic.getGeoX());
                }
                break;
            case ACTION.EVALUATION:
                ...
                if (commentsBean.getErrorCode().equals("6")) {
                    ...
                    FullactivityListViewAdapter fullcListViewAdapter = new FullactivityListViewAdapter(FullTwoActivity.this, commList);
            ...
            case ACTION.COMMENDGOODS:
                ...
                if (goodBean.getErrorCode().equals("6")) {
                    ...
                    if (goodBean.isSuccess()) {
                        ...
                        FullActivityGridViewAdapter gridViewAdapter = new FullActivityGridViewAdapter(FullTwoActivity.this, list);
