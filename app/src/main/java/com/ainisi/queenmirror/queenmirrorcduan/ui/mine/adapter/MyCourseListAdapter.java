...
public class MyCourseListAdapter extends RecyclerView.Adapter<MyCourseListAdapter.ViewHolder> {
    ...
    private List<MyCourseListBean.BodyEntity.ListEntity> mDatas;
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public MyCourseListAdapter(Context context, List<MyCourseListBean.BodyEntity.ListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }
...
//        });
    ...
    public void addData(int position, MyCourseListBean.BodyEntity.ListEntity entity) {
...
//            cardView.setContentPadding(5, 5, 5, 5);
    ...
    public interface OnItemClickListener {
        void onClick(View v, int position, List<MyCourseListBean.BodyEntity.ListEntity> entity);
    }
     ...
     * @param newData
     */
    public void refreshData(List<MyCourseListBean.BodyEntity.ListEntity> newData) {
        mDatas.clear();
     ...
     * @param moreData
     */
    public void loadMoreData(List<MyCourseListBean.BodyEntity.ListEntity> moreData) {
