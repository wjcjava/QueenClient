...
public class TopicSelectionListAdapter extends RecyclerView.Adapter<TopicSelectionListAdapter.ViewHolder> {
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public TopicSelectionListAdapter(Context context, List<DemoListModel.BodyEntity.MessListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_topic_selection_content, parent, false);
...
//        holder.tvMessageDetails.setText(mDatas.get(position).getMessDetails());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout rlTopicContent;

        public ViewHolder(View itemView) {
            super(itemView);
            tvFansName = itemView.findViewById(R.id.tv_fans_name);
            rlTopicContent=itemView.findViewById(R.id.rl_topic_content);
...
//            cardView.setContentPadding(5, 5, 5, 5);
            rlTopicContent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onClick(v, getLayoutPosition(), mDatas);
                    }
                }
            });
