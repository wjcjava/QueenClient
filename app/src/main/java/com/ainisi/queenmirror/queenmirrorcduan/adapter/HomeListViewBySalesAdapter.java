...
public class HomeListViewBySalesAdapter extends BaseAdapter {
    ...
    public HomeListViewBySalesAdapter(Context context, List<HomeShopBySalesBean.BodyBean.ShopListDataBean> ShopListData, String where) {
