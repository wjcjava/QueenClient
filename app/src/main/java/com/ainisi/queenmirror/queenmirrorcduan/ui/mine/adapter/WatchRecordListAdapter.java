...
public class WatchRecordListAdapter extends RecyclerView.Adapter<WatchRecordListAdapter.ViewHolder> {

    private List<WatchRecordBean.BodyEntity.RecordsListEntity> mDatas;
...
//    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    ...
    public WatchRecordListAdapter(Context context, List<WatchRecordBean.BodyEntity.RecordsListEntity> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_list_watch_record, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tvSubVideoName.setText(mDatas.get(position).getVideoTitle());
        holder.tvLastWatched.setText("最后观看:" + mDatas.get(position).getUpdateDate());
...
//        });
    ...
    public void addData(int position, WatchRecordBean.BodyEntity.RecordsListEntity entity) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvSubVideoName;
        private TextView tvLastWatched;
        ...
        public ViewHolder(View itemView) {
            ...
            tvSubVideoName = itemView.findViewById(R.id.tv_sub_video_name);
            tvLastWatched = itemView.findViewById(R.id.tv_last_watched);
...
//            cardView.setContentPadding(5, 5, 5, 5);
    ...
    public interface OnItemClickListener {
        void onClick(View v, int position, List<WatchRecordBean.BodyEntity.RecordsListEntity> entity);
    }
     ...
     * @param newData
     */
    public void refreshData(List<WatchRecordBean.BodyEntity.RecordsListEntity> newData) {
        mDatas.clear();
     ...
     * @param moreData
     */
    public void loadMoreData(List<WatchRecordBean.BodyEntity.RecordsListEntity> moreData) {
