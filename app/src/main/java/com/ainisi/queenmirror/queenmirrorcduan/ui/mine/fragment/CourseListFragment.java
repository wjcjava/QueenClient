 ...
 */
public class CourseListFragment extends Fragment implements HttpCallBack {
    ...
    public static CourseListFragment newInstance(String content) {
        Bundle arguments = new Bundle();
        arguments.putString(EXTRA_CONTENT, content);
        CourseListFragment tabContentFragment = new CourseListFragment();
