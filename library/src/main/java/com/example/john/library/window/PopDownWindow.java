...
import com.example.john.library.view.PopDownView;
...
public class PopDownWindow extends PopupWindow implements PopWindowInterface, View.OnClickListener,
    ...
    public PopDownWindow(Activity activity, int titleResId, int messageResId, PopWindowHome popWindow) {
    ...
    public PopDownWindow(Activity activity, CharSequence title, CharSequence message, PopWindowHome popWindow) {
