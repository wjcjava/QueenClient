package com.example.john.library.window;
...
import com.example.john.library.PopItemAction;
import com.example.john.library.PopSimpleAnimationListener;
import com.example.john.library.PopWindowHome;
import com.example.john.library.R;
import com.example.john.library.view.PopAlertView;
...
public class PopAlertDialog extends Dialog implements PopWindowInterface, DialogInterface.OnShowListener, View.OnClickListener,
    ...
    private PopWindowHome mPopWindow;
    ...
    public PopAlertDialog(Activity activity, int titleResId, int messageResId, PopWindowHome popWindow) {
    ...
    public PopAlertDialog(Activity activity, CharSequence title, CharSequence message, PopWindowHome popWindow) {
