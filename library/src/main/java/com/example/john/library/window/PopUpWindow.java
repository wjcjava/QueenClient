...
import com.example.john.library.view.PopUpView;
...
public class PopUpWindow extends Dialog implements PopWindowInterface, DialogInterface.OnShowListener, View.OnClickListener,
    ...
    public PopUpWindow(Activity activity, int titleResId, int messageResId, PopWindowHome popWindow) {
    ...
    public PopUpWindow(Activity activity, CharSequence title, CharSequence message, PopWindowHome popWindow) {
