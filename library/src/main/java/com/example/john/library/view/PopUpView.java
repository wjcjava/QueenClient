package com.example.john.library.view;
...
import com.example.john.library.PopWindowHelper;
import com.example.john.library.PopWindowHome;
import com.example.john.library.R;
import com.example.john.library.viewinterface.PopViewInterface;
...
public class PopUpView extends LinearLayout implements PopViewInterface {
    ...
    @Override
    public void setPopWindow(PopWindowHome popWindow) {
